...
class VolunteerPopScreen extends StatefulWidget {
  final DocumentSnapshot volunteerData;
  const VolunteerPopScreen({super.key, required this.volunteerData});

  @override
  State<VolunteerPopScreen> createState() => _VolunteerPopScreenState();
}

class _VolunteerPopScreenState extends State<VolunteerPopScreen> {
  ...
  Future<void> _getAddress() async {
    try {
      final coords = widget.volunteerData["Address"].toString().split(',');
      if (coords.length != 2) {
        setState(() {
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Center(
                child: Hero(
                  tag: 'volunteer_${widget.volunteerData.id}',
                  child: Container(
                    width: 150,
                    height: 150,
                    ...
                    child: ClipOval(
                      child: widget.volunteerData["profileImage"].isNotEmpty
                          ? (widget.volunteerData["profileImage"].startsWith('/data')
                              ? Image.file(
                                  File(widget.volunteerData["profileImage"][0]),
                                  fit: BoxFit.cover,
                                )
                              : Image.network(
                                  widget.volunteerData["profileImage"],
                                  fit: BoxFit.cover,
                                ))
                          : Container(
                  ...
                  children: [
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildInfoRow("Age", "${widget.volunteerData["age"]} years", themeProvider),
                            _buildInfoRow("Location", address, themeProvider),
                            _buildInfoRow(
                              "Joined",
                              "${widget.volunteerData["createdAt"]["date"]} at ${widget.volunteerData["createdAt"]["time"]}",
                              themeProvider,
                            ),
                          ],
                        ),
                      ...
                      child: Padding(
                        ...
                        child: Wrap(
                          ...
                          children: List<Widget>.generate(
                            widget.volunteerData["skills"].length,
                            (index) => Chip(
                              ...
                              label: Text(
                                widget.volunteerData["skills"][index],
                                style: TextStyle(
                    ...
                    Card(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(16),
                        child: Text(
                          widget.volunteerData["description"],
                          style: TextStyle(
                    ...
                    const SizedBox(height:10),
                            GestureDetector(
                              ...
                              onTap: (){
                                //Logic for requesting help from Volunteers 
                              },
                            )
                  ],
                ),
