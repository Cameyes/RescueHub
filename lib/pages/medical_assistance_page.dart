...
import 'package:food_delivery_app/pages/add_medical_assistance_details.dart';
import 'package:food_delivery_app/pages/edit_medical_assistance_details.dart';
import 'package:food_delivery_app/pages/map_screen.dart';
import 'package:food_delivery_app/pages/medical_assistance_pop_screen.dart';
...
class MedicalAssistancePage extends StatefulWidget {
  ...
  const MedicalAssistancePage({super.key, required this.userId,required this.location});

  @override
  State<MedicalAssistancePage> createState() => _MedicalAssistancePageState();
}

class _MedicalAssistancePageState extends State<MedicalAssistancePage>  with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchmedical() async {
    medicalStream = FirebaseFirestore.instance
        .collection("medical")
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(child: allMedicalDetails()),
        ],
      ),
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AddMedicalAssistanceDetails(
                Loc: widget.location,
  ...
  Widget allMedicalDetails() {
    ...
    return StreamBuilder(
      ...
      builder: (context, AsyncSnapshot snapshot) {
        ...
        List<DocumentSnapshot> medical = snapshot.data.docs;
        ...
        medical.sort((a, b) {
          ...
          bool allAvailable = medical.every((medical) {
            bool isActive = medical["status"] == "active";
            return isActive && (medical["availability"]["type"] == "Full Time" || 
                   isCurrentlyAvailable(medical["availability"]));
          });
...
return createdAtA.compareTo(createdAtB);
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            DocumentSnapshot ds = medical[index];
                                      ...
                                      child: Row(
                                          children: [
                                            Container(
                                              ...
                                              width: 70,
                                              decoration: BoxDecoration(
                                                color: themeProvider.isDarkMode?Colors.grey[600]:Colors.purple,
                                                borderRadius: BorderRadius.circular(12),
                                              ),
                                              child: Center(
                                                child: Text(
                                              ...
                                              child: IconButton(
                                                ...
                                                onPressed: () {
                                                  Navigator.push(
                                                    context, 
                                                    MaterialPageRoute(
                                                      builder: (context) => EditMedicalAssistanceDetails(
                                                        userId: widget.userId,
                                                        medicalId: ds.id,
                                                        medicalData: ds.data() as Map<String, dynamic>,
                      ...
                      onTap: () {
                        ...
                        if (isAvailable) {
                          Navigator.push(
                            context, 
                            MaterialPageRoute(
                              builder: (context) => MedicalAssistancePopScreen(medicalData: ds)
                            )
                          );
                        } else {
                          showDialog(
